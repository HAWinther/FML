...
CDM + massive neutrinos (linear). Including COLA up to 3LPT (free choice of the order). If gravity model has scaledependent growth then one can use scaledependent LPT for this or scale-independent if you want it to go faster at the expence of some accuracy.
