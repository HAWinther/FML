...
struct Galaxy{
  ...
  double weight;
  Galaxy(){}
  Galaxy(double _RA, double _DEC, double _z, double _weight) : 
...
int main(){
  ...
  double boxsize;
  FML::SURVEY::GalaxiesToBox<Galaxy, Particle>(galaxies.data(), galaxies.size(), particles, hubble_over_c_of_z, boxsize, shiftPositions, scalePositions, verbose);
