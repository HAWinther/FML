    ...
    namespace UTILS {
        ...
        namespace Matplotlib {
          ...
          http://bytes.com/topic/python/answers/793370-multiple-independent-python-interpreters-c-c-program
            ...
            template <typename Numeric>
            void
            plot_surface(const std::vector<::std::vector<Numeric>> & x,
            ...
            template <typename NumericX, typename NumericY>
            bool
            semilogx(const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "") {
                assert(x.size() == y.size());
            ...
            template <typename NumericX, typename NumericY>
            bool
            semilogy(const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "") {
                assert(x.size() == y.size());
            ...
            inline void xscale(const std::string & xscale) {
                PyObject * str = PyString_FromString(xscale.c_str());
                PyObject * args = PyTuple_New(1);
                PyTuple_SetItem(args, 0, str);
            ...
            inline void yscale(const std::string & yscale) {
                PyObject * str = PyString_FromString(yscale.c_str());
                PyObject * args = PyTuple_New(1);
                PyTuple_SetItem(args, 0, str);
