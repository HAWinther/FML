...
#define SPLINE_FIDUCIAL_SPLINE_WARNING   false
      ...
      class GSLSpline {
        ...
        public:
          ...
          DVector get_x_data(){
            return DVector(spline->x, spline->x + spline->size);
          }
          DVector get_y_data(){
            return DVector(spline->y, spline->y + spline->size);
          }
      ...
      class GSLSpline2D {
        private:
          ...
          typedef double (*evalfunc)(const gsl_spline2d*,
              double,
              double,
              gsl_interp_accel*,
              gsl_interp_accel*);
          ...
          std::vector<evalfunc> derivfunc {
            gsl_spline2d_eval, gsl_spline2d_eval_deriv_x,
              gsl_spline2d_eval_deriv_xx, gsl_spline2d_eval_deriv_y,
              gsl_spline2d_eval_deriv_xy, nullptr,
        ...
        public:
          ...
          DVector get_x_data(){
            return DVector(spline->xarr, spline->xarr + size_x);
          }
          DVector get_y_data(){
            return DVector(spline->yarr, spline->yarr + size_y);
          }
          DVector get_z_data(){
            return DVector(spline->zarr, spline->zarr + size_x*size_y);
          }
