...
#define FIDUCIAL_RELERR_ODE_PEEBLES 1e-12
    ...
    class RecombinationHistory {
      private:
        ...
        // Internal methods
        std::pair<double, double> electron_fraction_from_saha_equation_with_helium(
            double x) const;
        std::pair<double, double> electron_fraction_from_saha_equation_without_helium(
            double x) const;
      ...
      public:
        ...
        RecombinationHistory(std::shared_ptr<BackgroundCosmology> cosmo,
            ParameterMap& p);
